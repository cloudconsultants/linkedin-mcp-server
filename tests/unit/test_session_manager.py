...
class TestPlaywrightSessionManager:
    ...
    async def test_session_creation_success(self, mock_linkedin_session_class):
        ...
        session = await PlaywrightSessionManager.get_or_create_session("valid_cookie_123")
        
        assert session is not None
        mock_linkedin_session_class.from_cookie.assert_called_once_with("valid_cookie_123", headless=True)
    ...
    async def test_invalid_session_recreation(self, mock_linkedin_session_class, mock_session):
