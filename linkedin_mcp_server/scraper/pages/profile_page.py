...
class ProfilePageScraper(LinkedInPageScraper):
    ...
    def get_content_targets(self, fields: PersonScrapingFields = PersonScrapingFields.ALL) -> List[ContentTarget]:
                ...
                try:
                    ...
                    for element in elements:
                        if await element.is_visible():
                            ...
                            if any(char in text for char in [',', 'CA', 'NY', 'Area', 'Region']):
    ...
    async def _extract_experiences(self, page: Page, person: Person) -> None:
        ...
        try:
            ...
            from linkedin_mcp_server.scraper.scrapers.person.experience import scrape_experiences_main_page
    ...
    async def _extract_education(self, page: Page, person: Person) -> None:
        ...
        try:
            # Import existing extraction logic  
            from linkedin_mcp_server.scraper.scrapers.person.education import scrape_education_main_page
    ...
    async def _extract_accomplishments(self, page: Page, person: Person) -> None:
        ...
        try:
            # Import existing extraction logic
            from linkedin_mcp_server.scraper.scrapers.person.accomplishments import scrape_accomplishments_main_page
    ...
    async def _extract_interests(self, page: Page, person: Person) -> None:
        ...
        try:
            # Import existing extraction logic
            from linkedin_mcp_server.scraper.scrapers.person.interests import scrape_interests_main_page
    ...
    async def _extract_contacts(self, page: Page, person: Person) -> None:
        ...
        try:
            # Import existing extraction logic
            from linkedin_mcp_server.scraper.scrapers.person.contacts import scrape_contact_info
            from linkedin_mcp_server.scraper.scrapers.person.connections import scrape_connections_info
